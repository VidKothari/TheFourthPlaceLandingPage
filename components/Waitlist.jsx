...
export default function Waitlist() {
  ...
  return (
    <section id="waitlist" className="mobile-padding" style={{
      position: 'relative',
      ...
      <motion.div 
        initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1.5, ease: [0.16, 1, 0.3, 1] }}
        style={{ position: 'relative', zIndex: 2, maxWidth: '800px', width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <div style={{ width: '100%', maxWidth: '400px', position: 'relative', marginBottom: '60px' }}>
            ...
            {!submitted ? (
              ...
              >
                <div style={{ flex: 1, textAlign: 'left' }}>
                  <label htmlFor="waitlist-email" style={{ display: 'block', fontSize: '0.75rem', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.1em', opacity: 0.5, marginBottom: '8px' }}>
                    Enter email
                  </label>
                  <input 
                    id="waitlist-email"
                ...
                <span style={{ position: 'absolute', left: 0, bottom: 0, width: '100%', height: '1px', background: 'black', transform: 'scaleX(0)', transition: 'transform 1s cubic-bezier(0.19,1,0.22,1)', transformOrigin: 'left' }} className="waitlist-underline2" />
                <style jsx>{`
        ...
        <div style={{
          fontFamily: 'var(--sans)', fontSize: '0.8rem', fontWeight: 500, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--text-soft)'
        }}>
