...
export const VARIANTS = {
  1: {
    ...
    hero: {
      ...
      img: '/assets/redesign/hero-door-v2-poster.webp',
      imgAlt: 'A figure opens a door cut into a red wall, revealing a glowing constellation of framed pictures',
      video: {
        webm: '/assets/redesign/hero-door-v2.webm',
        mp4: '/assets/redesign/hero-door-v2.mp4',
        poster: '/assets/redesign/hero-door-v2-poster.webp',
        loop: true,
      },
